...
void menu()
{
	...
	do
	{
		...
		printf("\n---1. FORMARTAR O TEXTO E PREPARAR PARA LEITURA---");
		printf("\n---2. FAZER A LEITURA DOS DADOS---");
		printf("\n---3. EXIBIR COORDENADAS---"); //avisar que precisa fazer a 2 primeiro
		printf("\n---4. EXIBIR VELOCIDADES MEDIAS---");
		printf("\n---5. GERAR ARQUIVO DE SAIDA---");
		printf("\n---6. GERAR SERIE TEMPORAL---");
		printf("\n---7. CALCULAR CORRELACAO---");
		printf("\n---8. ENCERRAR EXECUCAO---\n");
		printf("\nOpcao: ");
		scanf("%d",&escolha);
